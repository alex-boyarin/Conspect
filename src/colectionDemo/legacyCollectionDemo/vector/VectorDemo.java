package colectionDemo.legacyCollectionDemo.vector;
 ...
 * потомки интерфейса листа, а так же с появлением ограниченых потокобезопасн. колекц. в java 5,
...
public class VectorDemo {
    public static void main(String[] args) {
        ...
        vector.addAll(vector);//так же можно добавить другую колекц. или этуже коллукцию.
