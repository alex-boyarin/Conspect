 ...
 * Подытожим интерфейсы мы используем тогда когда мы хотим принести какой-то функционал
...
//        Computer mobile = new Mobile(new Ssd(60), new Ram(2024));
    ...
    /**
    И в Printable у нас есть ограничения только к тому что нам предоставляет интерфейс Printable, следовательно,
     все что мы можем сделать это у printable вызвать метод print()
     */
