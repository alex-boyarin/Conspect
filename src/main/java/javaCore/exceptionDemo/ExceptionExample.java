 ...
 * Есть одно правило, исключения должны располагаться от потомка к предку по иерархии,
 * т.е. сверху в низ. Если этого не соблюдать то возможна ситуация когда в следущий
 * catch программа просто не зайдет т.к. исключение предназначенное для него, отловит
 * предыдущий блок.
 */
