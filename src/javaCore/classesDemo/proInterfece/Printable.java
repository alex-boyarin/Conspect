...
печати на консоль т.е. print и назовем его Printable. на практике очень распостранены
интерфейсы, гораздо чаще их используют чем абстракт. классы, в виду их невероятной
...
и ключевые слова static final. Мы неограничены в колличестве методов.
Обращаем внимание на название наших интерфейсов, т.е. они не должны
представлять из себя какой-то предмет, следовательно они должны называться как будто
