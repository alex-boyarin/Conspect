...
/**
 * Stream для примитивных типов. Дело в том что все коллекц. как мы заем не могут быть
...
public class StreamIntDoubleLongExample {
    public static void main(String[] args) {
        ...
        IntSummaryStatistics intSummaryStatistics = strings.stream()
                ...
                .sorted()
                .limit(2)
                .mapToInt(Integer::intValue)// теперь после преобразования у нас появляются новы возможности
...
//                .getMax()-максимальноезначение    > а можно просто указать summaryStatistics()
